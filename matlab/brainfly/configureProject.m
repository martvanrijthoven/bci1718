% configure files from the project
projectdir = '../../project';
addpath(fullfile(projectdir));

% --------
% from here on is configureGame.m with different parameters
useBuffer=true;
useKeyboard=true;
...
trialDuration     =4; % = 4.5s trials
baselineDuration  =1; % = 1.5s baseline
intertrialDuration=2; % = 1.5s post-trial
feedbackDuration  =1;
